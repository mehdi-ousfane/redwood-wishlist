...
describe('pairings', () => {
  ...
  scenario('creates a pairing', async (scenario: StandardScenario) => {
    const result = await createPairing({
      input: {
        ...
        updatedAt: '2024-04-11T09:33:45.279Z',
      },
    })
    ...
    expect(result.updatedAt).toEqual(new Date('2024-04-11T09:33:45.279Z'))
  })
  ...
  scenario('updates a pairing', async (scenario: StandardScenario) => {
    ...
    const result = await updatePairing({
      id: original.id,
      input: { updatedAt: '2024-04-12T09:33:45.279Z' },
    })

    expect(result.updatedAt).toEqual(new Date('2024-04-12T09:33:45.279Z'))
  })
