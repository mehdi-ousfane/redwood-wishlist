...
describe('events', () => {
  ...
  scenario('creates a event', async () => {
    const result = await createEvent({
      input: {
        name: 'String',
        date: '2024-04-11T09:36:27.599Z',
        updatedAt: '2024-04-11T09:36:27.599Z',
      },
    })

    expect(result.name).toEqual('String')
    expect(result.date).toEqual(new Date('2024-04-11T09:36:27.599Z'))
    expect(result.updatedAt).toEqual(new Date('2024-04-11T09:36:27.599Z'))
  })
